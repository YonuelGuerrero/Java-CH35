...
public class Employee {
	...
	//2. Metodo constructor. Tiene el mismo nombre que la clase, no returna nada, recibe parametros (atributos) y los asigna a variables del constructor (this)
	...
	void capacitarse() {
		System.out.println("El trabajador " + this.nombre + " del puesto " + this.puesto + " se capacita");
	}
