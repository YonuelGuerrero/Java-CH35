...
public class HashMapCollection {
	...
	//*** Ejemplo 02 ***//
		...
		calificaciones.put("Juanito", 9 );
		calificaciones.put("Yonuel", 10 );
		calificaciones.put("Eli", 10 );
		calificaciones.put("Fulanita", 5);
		calificaciones.put("La vieja del otro dia", 7);
	
		System.out.println(calificaciones);
		
		for(Map.Entry<String, Integer> promedio : calificaciones.entrySet()) {
			System.out.println("La calificacion de " + promedio.getKey() + " es " + promedio.getValue());
		}
