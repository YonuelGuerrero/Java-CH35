...
public class HashSetCollection {
	...
	public static void main(String[] args) {
		...
		/*
		 * La clase HAshSet no va a agarantizar que los elementos se muestren segun el orden establecido ya que busca eficientar la busqueda y recuperacion de los elementos
		 * Utiliza tablas hash para almacenar los elementos y mostrarlos al usuario
		 */
		
		//Metodo .clear(): Limpiar el HashSet
		animals.clear();
		System.out.println(animals);
